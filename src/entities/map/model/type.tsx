...
export const markerIconOptions: {
  ...
  { key: "coffee", label: "Кофейня", icon: <IconCoffee /> },
  { key: "cup", label: "Напитки", icon: <IconCup /> },
  { key: "burger", label: "Фастфуд", icon: <IconBurger /> },
  { key: "iceCream", label: "Мороженое", icon: <IconIceCream2 /> },
  ...
  { key: "microphone", label: "Микрофон", icon: <IconMicrophone /> },
  ...
  { key: "swim", label: "Пляж", icon: <IconSwimming /> },
